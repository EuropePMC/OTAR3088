...
## XL - 30 papers
# PMC4560075,PMC7334197,PMC8254301,PMC11354791,PMC11910553,PMC12141581,PMC12465344,PMC12698246,PMC12713268,PMC12859152,
# PMC12874668,PMC12925081,PMC12956499,PMC12958004,PMC12958006,PMC13014661,PMC13023379,PMC13027017,PMC13046829,PMC13049650,
# PMC13057132,PMC13062644,PMC13064416,PMC13065312,PMC13070050,PMC13071940,PMC13078898,PMC13082243,PMC13088768,PMC13093721
...
refsnp = [x for x in patterns if x['label'] in ["refsnp"]]
gca = [x for x in patterns if x['label'] in ["gca"]]
...
for pmcid in tqdm(papers):
    ...
    for sec in parsed.sections:
        ...
        for p, name in [(refsnp, "RefSNP"), (gca, "GCA")]:
            pattern = p[0]['pattern']
            epmc_matches.extend([(m.group(), m.start(), m.end(), name) for m in re.finditer(pattern, text)])
        ...
        # NOTE - For now no GeneProtein annotations are being added
